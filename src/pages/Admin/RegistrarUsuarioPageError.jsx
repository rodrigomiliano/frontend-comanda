...
function RegistrarUsuarioPageError() {
  ...
  useEffect(() => {
    // Eliminar "user" del localStorage al montar el componente
    localStorage.removeItem("user");
  }, []); // El array de dependencias está vacío, por lo que esto solo se ejecutará al montar el componente
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        navigate("/admin/registrar-usuario-2"); // Usa el hook de navegación para redirigir
      } else {
        console.error(
        ...
        navigate("/admin/registrar-usuario-error"); // Usa el hook de navegación para redirigir
      }
    } catch (error) {
      ...
      <Grid container justifyContent="center" className={classes.flexMargin}>
        <Grid item>
          <AlertComanda
            sev="error"
            tit="Error"
            desc="Ya existe un usuario con ese username y/o email"
          />
        </Grid>
      </Grid>
...
export default RegistrarUsuarioPageError;
